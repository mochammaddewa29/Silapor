        ...
        <div className="no-print border-t border-gray-100 bg-gray-50 px-4 py-3 sm:px-6 sm:py-4 dark:border-gray-800 dark:bg-gray-800/80 flex flex-col-reverse sm:flex-row items-center justify-between gap-3 shrink-0">
          ...
          <div className="w-full sm:w-auto flex items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="w-full inline-flex items-center justify-center gap-1.5 rounded-xl border border-blue-600 bg-blue-600 px-8 py-2.5 text-xs font-bold text-white shadow-lg shadow-blue-600/30 hover:bg-blue-700 transition-all"
            >
